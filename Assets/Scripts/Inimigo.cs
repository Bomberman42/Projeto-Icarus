...
public class Inimigo : MonoBehaviour
{
    ...
    private void MovementOfAttackingTheEnemy()
    {
        ...
        if (distance >= 0)
        {
            ...
            this.fisicaDoInimigo.velocity = new Vector2((directionBetweenTarget * (this.velocidade + 2)).x, this.transform.position.y);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(new Vector2(this.colisorDaEsquerda.position.x + (0.1f * direction), this.colisorDaEsquerda.position.y), new Vector2(this.colisorDaEsquerda.position.x + (0.1f * direction), this.colisorDaEsquerda.position.y + -0.8f));
